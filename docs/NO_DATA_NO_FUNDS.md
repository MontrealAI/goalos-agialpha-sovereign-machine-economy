...
GoalOS does not want user data. GoalOS does not want user funds. Do not submit private or regulated data. Demos are browser-local and require no accounts, wallets, transactions, secrets, or backend calls unless a page explicitly says otherwise.
