...
Purpose: evaluate whether a claim has enough evidence to move states. Audience: validators and institutional evaluators. What to do next: inspect claims matrix, baselines, replay, proof packets, risk ledger, and reviewer dissent. Related reports/scripts: release health and claim scan.
